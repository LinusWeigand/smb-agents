...
import { KnowledgeCards } from './knowledge/KnowledgeCards';
import { knowledgeUi } from './knowledge/i18n';
                    ...
                    <div className="relative min-w-0 flex-1">
                                ...
                                <div className="mb-6 flex items-center gap-3">
                                  <div className="flex min-w-0 flex-1 items-center gap-3">
                                    ...
                                    <div className="relative min-w-0 flex-1">
                                      ...
                                      <div className="flex h-9 w-full items-center rounded-[6px] border border-[#3D3D3D] bg-transparent pl-10 text-[14px] text-[#8C8C8C]">{ui.search}</div>
                                    </div>
                                  </div>
                                  <div className="flex shrink-0 items-center gap-3">
                                    ...
                                    <span className="group relative inline-flex h-[34px] shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-[6px] bg-white px-4 shadow-sm">
                                      ...
                                      <span className="relative z-10 font-orbitron text-sm font-semibold uppercase leading-none tracking-wider text-zinc-900 transition-colors delay-150 duration-300 group-hover:text-white">{ui.newEntry}</span>
                                    </span>
                                  </div>
                                </div>
                                <KnowledgeCards />
                      ...
                      <div className="absolute inset-x-0 top-0 z-30 flex h-16 items-center gap-2 pl-1 pr-3">
                        ...
                        <span className="flex min-w-0 items-center gap-2.5 text-[14px]">
                          <span className="cursor-pointer text-[#8C8C8C] transition-colors hover:text-[#FAFAFA]">{chrome.neuron}</span>
                          ...
                          <span className="flex min-w-0 items-center gap-1.5 text-[#FAFAFA]">
                            ...
                            <span className="truncate">{ui.breadcrumb}</span>
                          </span>
                        </span>
